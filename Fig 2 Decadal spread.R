# --------------------------------------------------------------------------
# --------- Script for mapping the spread of the Pacific oysters -----------
# --------------- in its introduced European range (Fig. 2) ----------------
# --------------------------------------------------------------------------
...
firstrec <- read.csv("./Data/First records/Initial_introductions.csv")
...
# Subset the first record data into each decade (cumulatively)
...
map_60s <- ggplot(data=world)+
  ...
  geom_star(data=databaserec_1960s, aes(x=Longitude, y=Latitude), size=4, 
...
map_70s <- ggplot(data=world)+
  ...
  scale_colour_manual(values=cc_pal)+
  scale_fill_discrete(drop=F)+
  geom_star(data=databaserec_1970s, aes(x=Longitude, y=Latitude), size=4, 
...
map_80s <- ggplot(data=world)+
  ...
  scale_colour_manual(values=cc_pal)+
  scale_fill_discrete(drop=F)+
  geom_star(data=databaserec_1980s, aes(x=Longitude, y=Latitude), size=4, 
            colour="black", fill="gold")+
  theme(legend.position="right", legend.title=element_text(face="bold"))+
  annotation_scale(location = "tl", line_width = 0.5, 
                   bar_cols=c("black", "dark grey"))+
...
map_90s <- ggplot(data=world)+
  ...
  scale_colour_manual(values=cc_pal)+
  scale_fill_discrete(drop=F)+
  geom_star(data=databaserec_1990s, aes(x=Longitude, y=Latitude), size=4, 
            colour="black", fill="gold")+
  theme(legend.position="right", legend.title=element_text(face="bold"))+
  annotation_scale(location = "tl", line_width = 0.5, 
                   bar_cols=c("black", "dark grey"))+
...
map_00s <- ggplot(data=world)+
  ...
  scale_colour_manual(values=cc_pal)+
  scale_fill_discrete(drop=F)+
  geom_star(data=databaserec_2000s, aes(x=Longitude, y=Latitude), size=4, 
            colour="black", fill="gold")+
  theme(legend.position="right", legend.title=element_text(face="bold"))+
  annotation_scale(location = "tl", line_width = 0.5, 
                   bar_cols=c("black", "dark grey"))+
...
map_10s <- ggplot(data=world)+
  ...
  scale_colour_manual(values=cc_pal)+
  scale_fill_discrete(drop=F)+
  geom_star(data=databaserec_2010s, aes(x=Longitude, y=Latitude), size=4, 
            colour="black", fill="gold")+
  theme(legend.position="right", legend.title=element_text(face="bold"))+
  annotation_scale(location = "tl", line_width = 0.5, 
                   bar_cols=c("black", "dark grey"))+
...
map_20s <- ggplot(data=world)+
  ...
  scale_colour_manual(values=cc_pal)+
  scale_fill_discrete(drop=F)+
  geom_star(data=databaserec_2020s, aes(x=Longitude, y=Latitude), size=4, 
            colour="black", fill="gold")+
  theme(legend.position="right", legend.title=element_text(face="bold"))+
  annotation_scale(location = "tl", line_width = 0.5, 
                   bar_cols=c("black", "dark grey"))+
