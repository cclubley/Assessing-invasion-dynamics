...
database <- read.csv("./Data/First records/Initial_introductions_no_angulata_new_data.csv")
...
write.csv(Max_distances_south, "./Data/Farthest points/Max_distances_south_new.csv", row.names=FALSE)  
...
Max_distances_south <- read.csv("./Data/Farthest points/Max_distances_south_new.csv")
